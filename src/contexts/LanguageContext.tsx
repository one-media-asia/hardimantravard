...
const translations = {
  ...
  en: {
    ...
    "admin.bookings.title": "Bokningar",
    "admin.bookings.description": "Visa och hantera bokningsförfrågningar sparade i webbläsaren.",
    "admin.bookings.refresh": "Uppdatera bokningar",
    "admin.bookings.clear": "Rensa alla",
    "admin.bookings.table.caption": "Senaste bokningsförfrågningar.",
    "admin.bookings.column.id": "ID",
    "admin.bookings.column.name": "Namn",
    "admin.bookings.column.email": "E-post",
