...
const translations = {
  ...
  en: {
    ...
    "admin.form.status": "Status",
    "admin.form.add": "Lägg till sökord",
    "admin.visitor.title": "Besökarsessioner",
    "admin.visitor.description": "Se var besökare kom från, hur länge de stannade och var de lämnade.",
    "admin.visitor.refresh": "Uppdatera sessioner",
    "admin.visitor.table.caption": "Senaste besökarsessioner.",
    "admin.visitor.column.sessionId": "Session",
    "admin.visitor.column.referrer": "Hänvisare",
    "admin.visitor.column.pages": "Besökta sidor",
