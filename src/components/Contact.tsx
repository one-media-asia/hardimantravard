    ...
    <section id="contact" ref={sectionRef} className="py-24 px-6 bg-secondary/50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 reveal">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold mb-6">{t('contact.title')}</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">{t('contact.description')}</p>
          <div className="mt-8">
            <Link to="/booking">
              <button className="inline-flex items-center justify-center rounded-full bg-primary px-6 py-3 text-white shadow-lg transition hover:bg-primary/90">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto reveal">
          {contactInfo.map((item, index) => (
            ...
            >
              <div className="p-4 mb-4 bg-primary/10 rounded-full text-primary">{item.icon}</div>
